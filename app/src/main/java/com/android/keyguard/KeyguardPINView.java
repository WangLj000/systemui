...
public class KeyguardPINView extends KeyguardPinBasedInputView {
    ...
    private void updateMargins() {
        ...
        for (ViewGroup vg : List.of(mRow1, mRow2, mRow3)) {
            ((LayoutParams) vg.getLayoutParams()).setMargins(0, 0, 0, bottomMargin);
        }

        bottomMargin = mContext.getResources().getDimensionPixelSize(
                R.dimen.num_pad_entry_row_margin_bottom);
        ((LayoutParams) mRow0.getLayoutParams()).setMargins(0, 0, 0, bottomMargin);
        ...
        if (mEcaView != null) {
            ...
            ((LayoutParams) mEcaView.getLayoutParams()).setMargins(0, ecaTopMargin,
                    0, ecaBottomMargin);
        }
