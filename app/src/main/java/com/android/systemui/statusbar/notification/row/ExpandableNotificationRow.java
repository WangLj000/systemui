...
public class ExpandableNotificationRow extends ActivatableNotificationView
    ...
    private OnClickListener mOnAppClickListener;
    private OnClickListener mOnFeedbackClickListener;
    ...
    public OnClickListener getBubbleClickListener() {
        return v -> {
    ...
    public OnClickListener getSnoozeClickListener(MenuItem item) {
        return v -> {
    ...
    public OnClickListener getFeedbackOnClickListener() {
    ...
    public interface LongPressListener {
        /**
         * Equivalent to {@link OnLongClickListener#onLongClick(View)} with coordinates
    ...
    public interface CoordinateOnClickListener {
        /**
         * Equivalent to {@link OnClickListener#onClick(View)} with coordinates
