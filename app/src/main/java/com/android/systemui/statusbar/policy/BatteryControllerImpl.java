...
public class BatteryControllerImpl extends BroadcastReceiver implements BatteryController {
    ...
    protected final ArrayList<BatteryStateChangeCallback>
    ...
    @Override
    public void addCallback(@NonNull BatteryStateChangeCallback cb) {
    ...
    @Override
    public void removeCallback(@NonNull BatteryStateChangeCallback cb) {
        synchronized (mChangeCallbacks) {
