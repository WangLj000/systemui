...
public class RemoteInputView extends LinearLayout implements View.OnClickListener {
    ...
    /**
     * Sets a {@link NotificationRemoteInputManager.BouncerChecker}
    ...
    public void addOnEditTextFocusChangedListener(OnFocusChangeListener listener) {
        mEditTextFocusChangeListeners.add(listener);
    }

    /** Removes a previously-added listener for focus-change events on the EditText */
    public void removeOnEditTextFocusChangedListener(OnFocusChangeListener listener) {
    ...
    private void onEditTextFocusChanged(RemoteEditText remoteEditText, boolean focused) {
        for (OnFocusChangeListener listener : new ArrayList<>(mEditTextFocusChangeListeners)) {
