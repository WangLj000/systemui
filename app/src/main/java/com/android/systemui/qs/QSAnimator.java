...
public class QSAnimator implements Callback, PageListener, Listener, OnLayoutChangeListener,
    ...
    private void translateContent(
            ...
            int yOffset,
            int[] temp,
            Builder animatorBuilderX,
            Builder animatorBuilderY
    ) {
    ...
    private void updateAnimators() {
        ...
        Builder firstPageBuilder = new Builder();
        Builder translationYBuilder = new Builder();
        Builder translationXBuilder = new Builder();
        ...
        mNonfirstPageAnimator = new Builder()
    ...
    static class HeightExpansionAnimator {
        ...
        HeightExpansionAnimator(Listener listener, int startHeight, int endHeight) {
            mListener = listener;
