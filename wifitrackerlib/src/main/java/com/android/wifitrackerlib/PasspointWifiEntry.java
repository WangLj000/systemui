...
public class PasspointWifiEntry extends WifiEntry implements WifiEntry.WifiEntryCallback {
    ...
    private List<Integer> mTargetSecurityTypes =new ArrayList<Integer>(){{
            add(WifiInfo.SECURITY_TYPE_PASSPOINT_R1_R2); add(SECURITY_TYPE_PASSPOINT_R3);add(SECURITY_TYPE_UNKNOWN);
    }};
