...
import static com.android.settingslib.wifi.WifiEntry.SPEED_FAST;
import static com.android.settingslib.wifi.WifiEntry.SPEED_MODERATE;
import static com.android.settingslib.wifi.WifiEntry.SPEED_NONE;
import static com.android.settingslib.wifi.WifiEntry.SPEED_SLOW;
import static com.android.settingslib.wifi.WifiEntry.SPEED_VERY_FAST;
...
public class Utils {
    ...
    public static int getAverageSpeedFromScanResults(@NonNull WifiNetworkScoreCache scoreCache,
        ...
        for (ScanResult scanResult : scanResults) {
            ...
            @WifiEntry.Speed int speed = scoredNetwork.calculateBadge(scanResult.level);
            if (speed != SPEED_NONE) {
                count++;
                totalSpeed += speed;
            }
    ...
    static String getSpeedDescription(@NonNull Context context, @NonNull WifiEntry wifiEntry) {
        ...
        @WifiEntry.Speed int speed = wifiEntry.getSpeed();
        switch (speed) {
